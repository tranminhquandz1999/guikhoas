        ...
        <div className="row">
          <div className="col-6">
            ...
            <div className="other-product-images d-flex flex-wrap gap-15">
              <div>
                <img
                  src="https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=wood-wristwatch-time-190819.jpg&fm=jpg"
                  className="img-fluid"
                  alt=""
                />
              </div>
          ...
          <div className="col-6">
            <div className="main-product-details">
              ...
              <div className=" py-3">
                ...
                <div className="d-flex gap-10 flex-column mt-2 mb-">
        ...
        <div className="row">
          <div className="col-12">
            ...
            <div className="bg-white p-3">
              <p>
                Lorem ipsum dolor, sit amet consectetur aduipsicing elit.
                Tenetur nisi similique illum aut perferendis voluptas, quisquam
                obcaecati qui Tenetur nisi similique illum aut perferendis
                voluptas, quisquam obcaecati qui
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="reviews mt-4">
                <div className="review">
                  ...
                  <p className="mt-3">
                    ...
                    quisquam obcaecati qui Tenetur nisi similique illum aut
                    perferendis voluptas, quisquam obcaecati qui
                  </p>
                </div>
              </div>
            </div>
